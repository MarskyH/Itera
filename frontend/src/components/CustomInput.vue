      ...
      <template #default>
        <div
          :class="classNames({
            ...
            ['bg-gray-100 cursor-not-allowed dark:bg-blackOlive-900 text-quickSilver-900']: disabled,
            ['outline-2 outline outline-red-500 dark:bg-blackOlive-900 text-quickSilver-900']: !meta.valid && meta.validated && meta.touched,
            ['outline-2 outline outline-emerald-500 dark:bg-blackOlive-900 text-quickSilver-900']: meta.valid && meta.validated && meta.dirty,
            ['']: withoutValidation,
