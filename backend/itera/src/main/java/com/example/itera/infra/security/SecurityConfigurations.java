    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,  "/pendency").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,  "/pendency/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,  "/pendency/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST,  "/pendency").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET,  "/priority").hasRole("ADMIN")
