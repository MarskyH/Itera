...
public interface TaskRepository extends JpaRepository<Task, String>{
    ...
    @Query(value = "SELECT t FROM Task t WHERE t.iteration.id = :id AND t.taskType = :taskType")
    TaskResponseDTO findByIterationTaskType(@Param("id") String id, @Param("taskType") String taskType);
