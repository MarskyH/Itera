...
public record TaskResponseDTO(String id, String title, String priority,  String details, String complexity, String effort, Integer sizeTask,Timestamp startDate, Timestamp endDate, Integer orderTask, String listName, String taskType, String taskrequirement_id, String taskimprovement_id, String taskbug_id, String iteration_id) {
