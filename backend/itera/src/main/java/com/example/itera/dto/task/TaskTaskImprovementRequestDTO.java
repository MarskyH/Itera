...
public record TaskTaskImprovementRequestDTO(TaskRequestImprovementDTO task, TaskImprovementRequestDTO taskImprovement, List<AssigneeRequestDTO> assignees) {
}
