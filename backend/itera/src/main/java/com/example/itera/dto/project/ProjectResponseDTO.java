...
public record ProjectResponseDTO(String id, String name, Integer deadline, Integer iterationTime, String workHours, String clientName, String createdBy, Timestamp creationDate, Timestamp modificationDate, Timestamp lastAccessDate) {
